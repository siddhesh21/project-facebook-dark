  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        justify-center p-2 cursor-pointer rounded-none rounded-bl-2xl"
        >
        ...
        <div
          className="flex items-center space-x-1 hover: bg-gray-100 flex-grow 
        justify-center p-2 cursor-pointer rounded-none"
        >
        ...
        <div
          className="flex items-center space-x-1 hover: bg-gray-100 flex-grow 
        justify-center p-2 cursor-pointer rounded-none rounded-br-2xl"
        >
